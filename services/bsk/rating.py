...
_PP_SR_CURVE: list[tuple[float, float]] = [
    ...
    (8000,  1400.0),   # 7.0★
    (9000,  1500.0),   # 7.5★
    (10000, 1500.0),   # 7.5★  ↓ flat
    (11000, 1600.0),   # 8.0★
    (12000, 1650.0),   # 8.25★
    (13000, 1700.0),   # 8.5★
    (14000, 1750.0),   # 8.75★
    (17000, 1750.0),   # 8.75★  ↓ flat
    (18000, 1800.0),   # 9.0★
    (19000, 1800.0),   # 9.0★   ↓ flat
    (20000, 1850.0),   # 9.25★
    (24000, 1850.0),   # 9.25★  ↓ flat
    (25000, 1900.0),   # 9.5★
    (28000, 1900.0),   # 9.5★   ↓ flat
    (29000, 1950.0),   # 9.75★
    (34000, 1950.0),   # 9.75★  ↓ flat
    (35000, 2000.0),   # 10.0★  (cap)
]

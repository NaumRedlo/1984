...
_PF_STRINGS = {
    "en": {
        ...
        "rank_history": "RANK HISTORY", "total_maps": "TOTAL GRADES:",
        "total_hits": "Total Hits", "avg_hits": "Avg Hits / Play",
        "max_combo": "Maximum Combo", "replays_watched": "Replays Watched by Others",
    ...
    "ru": {
        ...
        "accuracy": "Точность", "play_count": "Сыграно игр",
        "join_date": "Дата регистрации", "last_seen": "Последний визит",
        "online": "В сети", "hidden": "Скрыто",

        "grades": "ОЦЕНКИ", "top_plays": "ЛУЧШИЕ РЕЗУЛЬТАТЫ", "player_stats": "СТАТИСТИКА ИГРОКА",
        "rank_history": "ИСТОРИЯ РЕЙТИНГА", "total_maps": "ВСЕГО ОЦЕНОК:",
        "total_hits": "Всего попаданий", "avg_hits": "Ср. попаданий на игру",
        "max_combo": "Макс. комбо", "replays_watched": "Просмотров реплеев",
        "total_score": "Всего очков", "hours_played": "Часов в игре",
        "not_enough_data": "Недостаточно данных",
        "axis_90d": "90 дн. назад", "axis_60d": "60 дн. назад",
        "axis_30d": "30 дн. назад", "axis_now": "сейчас",
        "hours_suffix": "ч",
    },
}
